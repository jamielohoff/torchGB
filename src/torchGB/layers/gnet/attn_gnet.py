...
from .model import StochasticGenomicBottleNet,GenomicBottleNet, GNetLayerTuple
from ...utils import EncodingType, make_row_col_encoding, ceil, crop_matrix, build_matrix


def attn_gnet_layer(model: GenomicBottleNet, param: Tensor, hidden_dim: int,
...
def init_attn_gnet(model: GenomicBottleNet, pname: str, param: Tensor, 
    ...
    if "in_proj_weight" in pname:
        return attn_gnet_layer(model, param, hidden_dim, gnet_batchsize)
